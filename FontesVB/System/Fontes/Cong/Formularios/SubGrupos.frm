...
Begin VB.Form frmSubGrupos 
   ...
   End
End
Attribute VB_Name = "frmSubGrupos"
...
Private Sub cmdConsultar_Click()
   ...
   With clsCursor
      ...
      If Not .EOF Then
         ...
         Me.cmbAtivo.ListIndex = f1.CmbValor(Me.cmbAtivo, .Valor("Ativo"), enDescricao, 1)
...
Private Sub cmdExcluir_Click()
   ...
   With clsConexao
      ...
      .SQL.Limpar
      .SQL.Mais " DELETE FROM SubGrupos "
      .SQL.Mais " WHERE Empresa = " & .Txt(Prj.Sistema.IdEmpresa)
      .SQL.Mais " AND Codigo = " & .Vlr(Me.vlrCod)
...
Private Sub cmdSalvar_Click()
   ...
   Case "&Inserir"
      ...
      With clsConexao
         ...
         .SQL.Mais " INSERT INTO SubGrupos ( "
