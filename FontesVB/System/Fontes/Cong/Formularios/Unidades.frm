...
Private Sub cmdConsultar_Click()
   ...
   With clsCursor
      ...
      .SQL.Limpar
      .SQL.Mais " SELECT Empresa, Codigo, Descricao, Abreviatura, IdAtivo "
      ...
      If Not .EOF Then
         ...
         Me.cmbAtivo.ListIndex = f1.CmbValor(Me.cmbAtivo, .Valor("IdAtivo"), 1, 1)
...
Private Sub cmdSalvar_Click()
   ...
   If Not mCmpObrigatorio(clsErro, Me.txtDescricao, "Descrição") Then GoTo Erro_Msg
   If Not mCmpObrigatorio(clsErro, Me.txtAbreviatura, "Abreviatura") Then GoTo Erro_Msg
   ...
   Case "&Inserir"
      ...
      With clsConexao
         ...
         .SQL.Mais " INSERT INTO Unidades ( "
         .SQL.Mais "    Empresa, Codigo, Descricao, Abreviatura, IdAtivo "
         .SQL.Mais " ) VALUES ( "
...
Private Sub Form_Load()
   ...
   Me.cmbAtivo.Clear
   f1.CmbAdd Me.cmbAtivo, "Sim", 1
   f1.CmbAdd Me.cmbAtivo, "Não", 0
   Me.cmbAtivo.ListIndex = f1.CmbValor(Me.cmbAtivo, 1)
End Sub
